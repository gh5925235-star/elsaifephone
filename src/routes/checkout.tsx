...
{/* قسم الطلب المباشر عبر الواتساب */}
<div className="mb-4 mt-6 rounded-2xl border border-gray-200 bg-white p-5 text-center shadow-sm">
    <h3 className="mb-2 text-lg font-bold">الطلب المباشر عبر الواتساب</h3>
    <p className="mb-4 text-sm text-gray-500">
        أرسل تفاصيل طلبك مباشرة وسنكمل معك إجراءات الدفع والتوصيل.
    </p>
    
    <button
        onClick={handleWhatsAppOrder}
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] py-3 text-sm font-bold text-white transition hover:bg-[#1ebd5a]"
        type="button"
    >
